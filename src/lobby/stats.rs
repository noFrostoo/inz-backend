...
use super::lobby::{get_lobby, get_lobby_users};

#[derive(Clone, Debug, Serialize, Deserialize, Eq, PartialEq, Hash)]
pub struct GameStats {
    pub required_stats: Vec<()>,
}

#[derive(Clone, Debug, Serialize, Deserialize, Eq, PartialEq, Hash)]
pub struct UserStats {
    pub required_stats: Vec<UserStatsType>,
}
